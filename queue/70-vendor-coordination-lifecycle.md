# Vendor coordination lifecycle

**Sphere:** Property & Home
**Backlog item:** Vendor coordination lifecycle
**Depends on:** TBD — review existing tools and integrations before starting

## What to build

Draft/follow-up coordination for contractors with human approval
...
```
./scripts/gh-update-card.sh "Vendor coordination lifecycle" "In Review"
```

## Commit message

`feat: vendor coordination lifecycle`
