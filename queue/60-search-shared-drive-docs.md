# Search shared Drive docs

**Sphere:** Engine
**Backlog item:** Search shared Drive docs
**Depends on:** TBD — review existing tools and integrations before starting

## What to build

Needs Drive API tool
...
```
./scripts/gh-update-card.sh "Search shared Drive docs" "In Review"
```

## Commit message

`feat: search shared drive docs`
