# Post-meal feedback capture

**Sphere:** Meals & Kitchen
**Backlog item:** Post-meal feedback capture
**Depends on:** TBD — review existing tools and integrations before starting

## What to build

Depends on outreach + recipe DB
...
```
./scripts/gh-update-card.sh "Post-meal feedback capture" "In Review"
```

## Commit message

`feat: post meal feedback capture`
