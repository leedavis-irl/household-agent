...
**Sphere:** Engine
**Backlog item:** Security hardening wave
**Depends on:** TBD — review existing tools and integrations before starting

## What to build

Scope audits, key rotation, access review, abuse controls
...
```
./scripts/gh-update-card.sh "Security hardening wave" "In Review"
```

## Commit message

`feat: security hardening wave`
