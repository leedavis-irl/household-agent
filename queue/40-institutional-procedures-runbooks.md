# Institutional procedures/runbooks

**Sphere:** Engine
**Backlog item:** Institutional procedures/runbooks
**Depends on:** TBD — review existing tools and integrations before starting

## What to build

Repeatable process memory
...
```
./scripts/gh-update-card.sh "Institutional procedures/runbooks" "In Review"
```

## Commit message

`feat: institutional procedures runbooks`
