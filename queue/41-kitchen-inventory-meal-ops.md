# Kitchen inventory + meal ops

**Sphere:** Meals & Kitchen
**Backlog item:** Kitchen inventory + meal ops
**Depends on:** TBD — review existing tools and integrations before starting

## What to build

Extend into pantry/inventory tracking
...
```
./scripts/gh-update-card.sh "Kitchen inventory + meal ops" "In Review"
```

## Commit message

`feat: kitchen inventory meal ops`
