...
Adds Slack as a communication channel so household members can interact with Iji from Avalon MGMT workspace in addition to Signal.
...
```
./scripts/gh-update-card.sh "Slack channel adapter" "In Review"
```

## Commit message

`feat: slack channel adapter`
