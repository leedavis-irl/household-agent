# Meal planning + grocery coordination intelligence

**Sphere:** Procurement & Errands
**Backlog item:** Meal planning + grocery coordination intelligence
...
```
./scripts/gh-update-card.sh "Meal planning + grocery coordination intelligence" "In Review"
```
