...
**Backlog item:** Weekly menu management
**Depends on:** TBD — review existing tools and integrations before starting

## What to build

Chef proposal + household feedback cycle
...
```
./scripts/gh-update-card.sh "Weekly menu management" "In Review"
```

## Commit message

`feat: weekly menu management`
