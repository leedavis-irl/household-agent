# Skip recurring delivery

**Sphere:** Procurement & Errands
**Backlog item:** Skip recurring delivery
**Depends on:** TBD — review existing tools and integrations before starting

## What to build

Needs reverse-engineered Safeway API
...
```
./scripts/gh-update-card.sh "Skip recurring delivery" "In Review"
```

## Commit message

`feat: skip recurring delivery`
