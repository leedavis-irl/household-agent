...
**Backlog item:** Registration/insurance tracking
**Depends on:** TBD — review existing tools and integrations before starting

## What to build

Renewal reminders + document refs
...
```
./scripts/gh-update-card.sh "Registration/insurance tracking" "In Review"
```

## Commit message

`feat: registration insurance tracking`
