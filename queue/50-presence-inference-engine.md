...
**Backlog item:** Presence inference engine
**Depends on:** TBD — review existing tools and integrations before starting

## What to build

Probabilistic presence from multi-source signals
...
```
./scripts/gh-update-card.sh "Presence inference engine" "In Review"
```

## Commit message

`feat: presence inference engine`
