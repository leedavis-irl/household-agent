# Passive group fact extraction

**Sphere:** Engine
**Backlog item:** Passive group fact extraction
**Depends on:** TBD — review existing tools and integrations before starting

## What to build

Requires explicit privacy decision
...
```
./scripts/gh-update-card.sh "Passive group fact extraction" "In Review"
```

## Commit message

`feat: passive group fact extraction`
