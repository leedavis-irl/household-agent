# Preference profiles (learned)

**Sphere:** Engine
**Backlog item:** Preference profiles (learned)
**Depends on:** TBD — review existing tools and integrations before starting

## What to build

Confidence-scored learned preferences
...
```
./scripts/gh-update-card.sh "Preference profiles (learned)" "In Review"
```

## Commit message

`feat: preference profiles learned`
