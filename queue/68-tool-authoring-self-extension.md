# Tool authoring (self-extension)

**Sphere:** Engine
**Backlog item:** Tool authoring (self-extension)
...
```
./scripts/gh-update-card.sh "Tool authoring (self-extension)" "In Review"
```

## Commit message

`feat: tool authoring self extension`
