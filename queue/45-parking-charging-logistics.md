# Parking/charging logistics

**Sphere:** Procurement & Errands
**Backlog item:** Parking/charging logistics
**Depends on:** TBD — review existing tools and integrations before starting

## What to build

Coordination + reminder workflows
...
```
./scripts/gh-update-card.sh "Parking/charging logistics" "In Review"
```

## Commit message

`feat: parking charging logistics`
